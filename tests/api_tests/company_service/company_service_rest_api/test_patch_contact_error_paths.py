...
def test_patch_contact_with_empty_token(company_service_rest_api, env_data, company_id_with_contact_id_teardown):
    ...
    response, parsed_body = company_service_rest_api.patch_contact(
        company_id=company_id, contact_id=contact_id, access_token=None, body=body)
...
def test_patch_contact_with_invalid_token(
...
def test_patch_contact_using_token_with_non_required_scope(
        company_service_rest_api, access_token_with_company_read_scope, env_data,
        company_id_with_contact_id_teardown):
    company_id, contact_id = company_id_with_contact_id_teardown
    body = company_service_rest_api.generate_random_patch_contact_request_body()
    response, parsed_body = company_service_rest_api.patch_contact(
        company_id=company_id, contact_id=contact_id, access_token=access_token_with_company_read_scope, body=body)
...
def test_patch_contact_with_non_existing_company(
    ...
    body = company_service_rest_api.generate_random_patch_contact_request_body()
    response, parsed_body = company_service_rest_api.patch_contact(
        company_id=company_id, contact_id=contact_id, access_token=access_token_with_company_write_scope, body=body)
...
def test_patch_contact_with_non_existing_contact(
        company_service_rest_api, access_token_with_company_write_scope, env_data):
...
def test_patch_contact_with_empty_name(
        company_service_rest_api, access_token_with_company_write_scope, env_data,
        company_id_with_contact_id_teardown):
    company_id, contact_id = company_id_with_contact_id_teardown
    body = company_service_rest_api.generate_random_patch_contact_request_body()
...
def test_patch_contact_with_too_long_name(
        company_service_rest_api, access_token_with_company_write_scope, env_data,
        company_id_with_contact_id_teardown):
    company_id, contact_id = company_id_with_contact_id_teardown
    body = company_service_rest_api.generate_random_patch_contact_request_body()
...
def test_patch_contact_with_html_in_name(
        company_service_rest_api, access_token_with_company_write_scope, env_data,
        company_id_with_contact_id_teardown):
    company_id, contact_id = company_id_with_contact_id_teardown
    body = company_service_rest_api.generate_random_patch_contact_request_body()
