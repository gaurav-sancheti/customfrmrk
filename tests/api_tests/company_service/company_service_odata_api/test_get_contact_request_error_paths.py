def test_get_contact_request_using_token_with_non_required_scope(
        company_service_odata_api, access_token_with_company_write_scope):

    response, parsed_body = company_service_odata_api.get_contact_request(
...
def test_get_contact_request_with_invalid_token(
        company_service_odata_api, invalid_access_token_based_on_random_base64_encoded_string):
