def test_get_contact_using_token_with_non_required_scope(
        company_service_odata_api, access_token_with_company_write_scope):

    response, parsed_body = company_service_odata_api.get_contact(
...
def test_get_contact_with_invalid_token(
